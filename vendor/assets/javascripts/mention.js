            ...
            var settings = $.extend({}, this.opts, options),
                ...
                _render = function(items) {
                    ...
                    items = $(items).map(function(i, item) {
                        ...
                        if (item.name) {
                            _linkHtml.append('<b class="mention_name">' + that.highlighter(item.name) + '</b>');
                        }
                        if (item.username) {
                            _linkHtml.append('<span class="mention_username"> ' + settings.delimiter + that.highlighter(item.username) + '</span>');
                        }
